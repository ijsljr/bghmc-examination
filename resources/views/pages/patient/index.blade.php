        ...
        <table class="table table-sm" style="text-align:left;">
            ...
            <tbody id="dynamic-row" style="font-size:13px; vertical-align:middle">
                ...
                <tr>
                    ...
                    <td style="width: 27%"><a class="btn btn-warning btn-sm active" id="buttonEdit" href="{{ route('patients.show',  $patient_admission->id)}}"><b>VIEW</b></a>&nbsp<a class="btn btn-outline-warning btn-sm" id="buttonEdit" href="{{ route('admit',  $patient_admission->id)}}"><b>ADMIT</b></a>&nbsp<a class="btn btn-outline-warning btn-sm" id="buttonEdit" href="{{ route('discharge',  $patient_admission->id)}}"><b>DISCHARGE</b></a>&nbsp<a class="btn btn-outline-info btn-sm" id="buttonEdit" href="{{ route('patients.edit',  $patient_admission->id)}}"><b>EDIT</b></a>&nbsp<a class="btn btn-outline-danger btn-sm" id="buttonEdit" href="{{ route('patientSoftDelete', $patient_admission->id) }}"><b>DELETE</b></a></td>
                </tr>
                @endforeach
                <tr>

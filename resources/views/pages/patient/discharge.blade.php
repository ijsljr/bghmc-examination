    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('dischargePatient', $patients_admission_details->id)}}" style="font-size: 13px">
            ...
            <div class="row mb-3">
                ...
                <label class="col-sm-6 col-form-label" name="first_name" id="first_name" value=""><?php if(empty($patient_details->middle_name) && isset($patient_details->suffix_name)  ) {
            ...
            <div class="row mb-3">
                ...
                <label class="col-sm-6 col-form-label" name="address" id="address">{{ $patient_details->address }}</label>
            </div>
    
            <div class="row mb-3">
                <label for="birthdate" class="col-sm-2 col-form-label">DATE OF BIRTH</label>
                <label class="col-sm-6 col-form-label" name="birthdate" id="birthdate">{{ $patient_details->birthdate }}</label>
            </div>

            <div class="row mb-3">
                <label for="ward" class="col-sm-2 col-form-label">WARD</label>
                <label class="col-sm-6 col-form-label" name="ward" id="ward">{{ $patients_admission_details->ward_name }}</label>
            </div>

            <div class="row mb-3">
                <label for="ward" class="col-sm-2 col-form-label">ADMISSION DATE/TIME</label>
                <label class="col-sm-6 col-form-label" name="ward" id="ward"><?php $date = date_create($patients_admission_details->admission_date_time); echo date_format($date, "F d, Y h:i A");?></label>
            </div>
